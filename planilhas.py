...
class ConverterPlanilhas:
    ...
    def obter_informacoes(self, identificacao_procurado, arquivo_json):
        ...
        with open(arquivo_json, 'r', encoding='utf-8') as f:
            ...
            if similar:
                #print(f"Identificador '{identificacao_procurado}' não encontrado, mas similar a '{similar[0]}'")
            ...
            if parcial:
                #print(f"Identificador '{identificacao_procurado}' não encontrado, mas parcialmente correspondente a '{parcial}'")
        ...
        for row in self.sheet.iter_rows(min_row=2, max_row=self.sheet.max_row, min_col=3, max_col=4, values_only=True):
            ...
            if identificador:
                ...
                if informacao:
                    ...
                    print(f"Identificador '{identificador}' não encontrado.")
...
preco_planilha = 'preco.xlsx'
saida_json = 'dicionario.json'
